      ...
      <div className="Container_test">
        ...
        <div className="message_table">
          ...
          <ScrollToBottom className="scrollbottom">
            <div className="test_morebtn">
              <button onClick={this.incMsgnum} className="test_more">
                더보기{" "}
              </button>
            </div>
            {this.state.premsg.slice(-this.state.msgnum).map((message) => {
